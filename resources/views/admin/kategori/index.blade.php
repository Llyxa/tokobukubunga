                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{route('kategori.create')}}" class="btn btn-primary waves-effect waves-float waves-light">Tambah Kategori</a>
                        </div>
                                ...
                                <tbody>
                                    @foreach($kategori as $row)
                                        <tr>
                                            ...
                                            <td>{{$row->kategori}}</td>
                                            <td>
                                                <a href="{{route('kategori.edit', $row->id)}}" class="btn btn-warning waves-effect waves-float waves-light">Edit</a>
