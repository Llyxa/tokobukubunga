                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Form Genre
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    @endif
                                <form class="form form-vertical" action="{{@$genre ? route('genre.update',$genre->id) : route('genre.store')}}"
                                ...
                                @endif
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{route('genre.index')}}" type="reset" class="btn btn-outline-secondary">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
